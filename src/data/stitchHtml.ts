...
export const STITCH_ALIASES: Record<string, string> = {
  // Auth variants — all are login/signup variations, reasonable to share
  ...
  // Marketing aliases — all point to other marketing pages (same category)
  ...
  // AI Apps — same-category only
  "ai-apps/speech-to-text": "ai-apps/voice-generator",
  "ai-apps/text-to-speech": "ai-apps/voice-generator",
  ...
  "ai-apps/voice-clone": "ai-apps/voice-generator",
  "ai-apps/avatar-creator": "ai-apps/image-generator",

  // CRM — same-category aliases only
  ...
  // Docs — all point to documentation (same page, different sections)
  "docs/docs-installation": "docs/docs-installation",
